...
<div class="judul">
    <h1>DAFTAR TEMAN SMP</h1>
</div>
    <div class="card-container">
        <?php
        include 'index.php';
        
        $sql="SELECT teman.gambar, teman.alamat,  teman_smp.nama_panggilan, teman_smp.kelas, teman_smp.asal_sd
        FROM teman
        RIGHT JOIN teman_smp ON teman.id_teman = teman_smp.id_teman";
