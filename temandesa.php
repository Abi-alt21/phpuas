...
<div class="judul">
    <h1>DAFTAR TEMAN DESA</h1>
</div>
    <div class="card-container">
        <?php
        include 'index.php';
        
        $sql="SELECT teman.gambar, teman.alamat,  teman_desa.nama_panggilan, teman_desa.nomer_rumah, teman_desa.hobi
        FROM teman
        INNER JOIN teman_desa ON teman.id_teman = teman_desa.id_teman";
            ...
            while ($row = $result->fetch_assoc()) {
                echo '<div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <p>Hobi: ' . $row['hobi'] . '</p>
                            <p>Nomor Rumah: ' . $row['nomer_rumah'] . '</p>
