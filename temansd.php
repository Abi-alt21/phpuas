...
<div class="judul">
    <h1>DAFTAR TEMAN SD</h1>
</div>
    <div class="card-container">
        <?php
        include 'index.php';
        $sql = "SELECT 
                    teman_sd.nama_panggilan, teman_sd.kelas, teman_sd.asal_tk, 
                    teman.gambar, teman.alamat 
                FROM teman_sd
                INNER JOIN teman ON teman_sd.id_teman = teman.id_teman";
