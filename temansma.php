...
<div class="judul">
    <h1>DAFTAR TEMAN SMA</h1>
</div>
    <div class="card-container">
        <?php
        include 'index.php';
        
        $sql="SELECT teman.gambar, teman.alamat,  teman_sma.nama_panggilan, teman_sma.kelas, teman_sma.asal_smp
        FROM teman
        INNER JOIN teman_sma ON teman.id_teman = teman_sma.id_teman";
